...
public class ArsenalSounds
{
    ...
    public static final RegistryObject<SoundEvent> STEVENS_OVER_UNDER = register("item.m555ou.fire");
    ...
    public static final RegistryObject<SoundEvent> DIAMONDBACK = register("item.diamondback.fire");
